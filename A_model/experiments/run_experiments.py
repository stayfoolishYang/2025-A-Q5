"""Actual complete trajectories; append results after each run for auditability."""
...
def main():
    ...
    def run(name,**kwargs):
        ...
        options=dict(n=41,dt=2.,end=432000.,interval=60.,event=True)
    ...
    for model,moving,label in ((2,False,'q3'),(4,True,'q4')):
        for n in (21,41,81):
    ...
    run('q4_fixed_radius',model=4,moving=False,end=864000.)
    run('q4_material_coordinate',model=4,moving=True,ale=False)
    for model,moving,label in ((2,False,'q3'),(4,True,'q4')):
