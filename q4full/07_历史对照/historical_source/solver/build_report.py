...
Q4案例ANON_CASE清除10/10，但触发两次光学网格兜底，累计移动约224公里、清除尝试420次，平均时间4955.39秒/源。该结果显著差于前两例，表明当前保守兜底可能主导总耗时；全清除不等于效率稳定。后续优化应首先减少兜底前的定位失败及兜底路径代价，并保留同等的清除保证。
...
[3] Dietrich Gebert. Ponytail skill. http<LOCAL_PATH>

[4] Tokekar P, Isler V. Sensor Placement and Selection for Bearing Sensors with Bounded Uncertainty. Proceedings of ICRA, 2013:2515–2520. DOI:10.1109/ICRA.2013.6630920. 作者原文：http<LOCAL_PATH>

[5] Tokekar P, Vander Hook J, Isler V. Active Target Localization for Bearing Based Robotic Telemetry. IROS, 2011. 作者页面：http<LOCAL_PATH>

[6] Vander Hook J, Tokekar P, Isler V. Cautious Greedy Strategy for Bearing-only Active Localization: Analysis and Field Experiments. Journal of Field Robotics, 2014, 31(2):296–318. DOI:10.1002/rob.21499. 作者原文：http<LOCAL_PATH>

[7] Engin S, Isler V. Active Localization of Multiple Targets from Noisy Relative Measurements. WAFR 2020项目页面：http<LOCAL_PATH>
'''
